#ifndef HW3_LIBMINI_H_
#define HW3_LIBMINI_H_
...
/* 5 system calls required in homework 3 */
long sys_rt_sigaction(int sig, const struct ksigaction *act,
                      struct ksigaction *oact, size_t sigsetsize);
long sys_rt_sigprocmask(int how, const sigset_t *nset, sigset_t *oset,
                        size_t sigsetsize);
...
/* 12 functions required in homework 3 */
