...
{
	/* TODO: Lab3, Print the kernel code and data section size 
	 ...
	 *       offset.
	 */
	extern uint32_t kernel_load_addr[], etext[], data_start[], end[];
	cprintf("Kernel code base start = %#x, size = %d\n", kernel_load_addr, etext - kernel_load_addr);
	cprintf("Kernel data base start = %#x, size = %d\n", data_start, end - data_start);
