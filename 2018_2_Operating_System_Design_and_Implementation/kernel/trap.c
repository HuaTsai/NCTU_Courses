...
/* TODO: Lab3, Interrupt descriptor table
 * Must be built at run time because shifted function addresses can't be represented in relocation records.
...
{
	// TODO: Lab3, handle specific interrupts
	// Handle spurious interrupts
	// The hardware sometimes raises these because of noise on the
	// IRQ line or other reasons. We don't care.
	// TODO: Lab6, cur_task to thiscpu->cpu_task
...
void trap_init()
{
	// TODO: Lab3, initialize interrupt descriptor table
	int i;
